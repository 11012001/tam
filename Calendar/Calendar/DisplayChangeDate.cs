...
namespace Calendar
{
    public partial class DisplayChangeDate : UserControl
    {
        ...
        {
            #region Set Up Năm
            ComboBoxSolarYear.Items.AddRange(Enumerable.Range(2, 9998).Select(i => (object)i).ToArray());
        ...
        private event EventHandler detail;
        ...
        private void buttonChoiceDetailDate_Click(object sender, EventArgs e)
        {
            Solar = GetDateTime();
            if (detail != null)
                detail(this, new EventArgs());
        }
        ...
        private event EventHandler detaillunnar;
        public event EventHandler DetailLunnar
        {
            add { detaillunnar += value; }
            remove { detaillunnar -= value; }
        }

        private void buttonChoiceDate_Click(object sender, EventArgs e)
        {
            Lunar = GetDateTimeLN();
            if (detaillunnar != null)
                detaillunnar(this, new EventArgs());
        }
